...
const createNewUser = (req, res)=>{
    if(!req.body.name || !req.body.lastname || !req.body.username || !req.body.password || !req.body.confirm_password || !req.body.role_id){
...
module.exports = { 
    ...
    createNewUser, 
    login
>>>>>>> dee0577a07c8341503dbc835d31d4b0b071f1149
};